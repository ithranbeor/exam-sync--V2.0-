...
const Programs: React.FC<ProgramsProps> = ({ user: _user }) => {
  ...
  }, [filteredPrograms, currentPage, effectiveItemsPerPage, totalItems]);
      ...
      {showDeleteConfirm && (
        <div className="modal-overlay" onClick={() => setShowDeleteConfirm(false)}>
          <div className="modal delete-confirm-modal" onClick={(e) => e.stopPropagation()}>
            <h3>Are you sure to delete this Program?</h3>
            <p className="delete-confirm-message">
              {deleteCount === 1 
                ? 'Delete this one program' 
                : `Delete these ${deleteCount} programs`}
            </p>
            <div className="modal-actions">
              <button 
                type="button" 
